...
export const dataList: WebNavigationListRow[] = [
  {
    ...
    name: 'genkit-movie-info-agent',
    title: 'Genkit - Movie Info Agent',
    content: 'This agent uses the TMDB API to answer questions about movies. Part of the Google Genkit sample agents.',
    url: 'https://github.com/google/A2A/tree/main/samples/js/src/agents',
    imageUrl: 'https://dummyimage.com/800x450/1d3557/ffffff&text=Movie+Info+Agent',
    thumbnailUrl: 'https://dummyimage.com/400x225/1d3557/ffffff&text=Movie+Info+Agent',
  },
  {
    id: '1801234567890123457',
    name: 'genkit-coder-agent',
    title: 'Genkit - Coder Agent',
    content:
      'This is a simple code-writing agent that emits full code files as artifacts. Part of the Google Genkit sample agents.',
    url: 'https://github.com/google/A2A/tree/main/samples/js/src/agents',
    imageUrl: 'https://dummyimage.com/800x450/1d3557/ffffff&text=Coder+Agent',
    thumbnailUrl: 'https://dummyimage.com/400x225/1d3557/ffffff&text=Coder+Agent',
  },
  {
    id: '1801234567890123458',
    name: 'langgraph-currency-converter',
    title: 'LangGraph - Currency Converter',
    content:
      'A currency conversion agent using LangGraph that supports multi-turn conversations to complete currency conversion tasks.',
    url: 'https://github.com/google/A2A/tree/main/samples/python/agents/langgraph',
    imageUrl: 'https://dummyimage.com/800x450/1d3557/ffffff&text=Currency+Converter',
    thumbnailUrl: 'https://dummyimage.com/400x225/1d3557/ffffff&text=Currency+Converter',
  },
  {
    id: '1801234567890123459',
    name: 'crewai-image-generator',
    title: 'CrewAI - Image Generator',
    content: 'A simple image generation agent built with CrewAI that demonstrates how to host an A2A server.',
    url: 'https://github.com/google/A2A/tree/main/samples/python/agents/crewai',
    imageUrl: 'https://dummyimage.com/800x450/1d3557/ffffff&text=Image+Generator',
    thumbnailUrl: 'https://dummyimage.com/400x225/1d3557/ffffff&text=Image+Generator',
  },
  {
    id: '1801234567890123460',
    name: 'google-adk-expense',
    title: 'Google ADK - Expense Reimbursement',
    content:
      'An expense reimbursement agent built with the Agent Development Kit (ADK) that uses webforms to collect missing information.',
    url: 'https://github.com/google/A2A/tree/main/samples/python/agents/google_adk',
    imageUrl: 'https://dummyimage.com/800x450/1d3557/ffffff&text=Expense+Reimbursement',
    thumbnailUrl: 'https://dummyimage.com/400x225/1d3557/ffffff&text=Expense+Reimbursement',
  },
];
...
export const detailList: WebNavigationDetailData[] = [
  {
    ...
    title: 'Genkit - Movie Info Agent',
    detail:
      "# Genkit - Movie Info Agent\n\n## Overview\nThe Movie Info Agent is a sample agent from Google's A2A (Agent2Agent) protocol that demonstrates how AI agents can provide information about movies. This agent integrates with The Movie Database (TMDB) API to answer questions about movies, actors, directors, and more.\n\n## Features\n- **Movie Information Retrieval**: Query details about movies such as plot summaries, release dates, cast members, and ratings\n- **TMDB API Integration**: Leverages the comprehensive movie database from TMDB\n- **Natural Language Understanding**: Process and respond to questions asked in natural language\n- **A2A Protocol Implementation**: Demonstrates the A2A protocol for agent communication\n\n## Use Cases\n- **Movie Recommendations**: Get suggestions for movies based on preferences\n- **Film Research**: Find information about specific movies or directors\n- **Entertainment Applications**: Integrate movie data into entertainment applications\n\n## Implementation Details\nThis agent is implemented using Google's Genkit framework and serves as an example of how to build specialized AI agents that can interact through the A2A protocol. The code demonstrates best practices for agent development, API integration, and handling user queries.\n\n## How to Use\nDevelopers can explore this sample implementation to understand how to build their own agents using the A2A protocol. To use or modify this agent:\n\n1. Clone the A2A repository: `git clone https://github.com/google/A2A.git`\n2. Navigate to the samples directory: `cd A2A/samples/js/src/agents`\n3. Explore the Movie Info Agent implementation\n4. Follow the documentation to run or modify the agent\n\n## More Information\nFor more information about the A2A protocol and how to build your own agents, visit the [A2A GitHub repository](https://github.com/google/A2A).",
    content: 'This agent uses the TMDB API to answer questions about movies. Part of the Google Genkit sample agents.',
    url: 'https://github.com/google/A2A/tree/main/samples/js/src/agents',
    imageUrl: 'https://dummyimage.com/800x450/1d3557/ffffff&text=Movie+Info+Agent',
    thumbnailUrl: 'https://dummyimage.com/400x225/1d3557/ffffff&text=Movie+Info+Agent',
    collectionTime: '2024-05-25 00:00:00',
    tagName: 'A2A Agents',
    websiteData: 'https://github.com/google/A2A',
    starRating: 5,
    categoryName: 'A2A',
  },
  {
    ...
    title: 'Genkit - Coder Agent',
    detail:
      "# Genkit - Coder Agent\n\n## Overview\nThe Coder Agent is a sample agent from Google's A2A (Agent2Agent) protocol that demonstrates how AI agents can assist with code generation. This simple agent can write complete code files based on requirements and emit them as artifacts.\n\n## Features\n- **Code Generation**: Creates full code files based on requirements specifications\n- **Multiple Language Support**: Can generate code in various programming languages\n- **Artifact Generation**: Produces code files as artifacts that can be used directly by developers\n- **A2A Protocol Implementation**: Demonstrates the A2A protocol for agent communication\n\n## Use Cases\n- **Rapid Prototyping**: Quickly generate code prototypes based on requirements\n- **Code Scaffolding**: Create boilerplate code for new projects\n- **Learning Tool**: Demonstrate coding patterns and best practices\n- **Integration Example**: Show how code generation can be integrated into AI agent ecosystems\n\n## Implementation Details\nThis agent is implemented using Google's Genkit framework and serves as an example of how to build specialized AI agents that can interact through the A2A protocol. The implementation shows how to handle code generation requests and return complete code files as structured artifacts.\n\n## How to Use\nDevelopers can explore this sample implementation to understand how to build their own agents using the A2A protocol. To use or modify this agent:\n\n1. Clone the A2A repository: `git clone https://github.com/google/A2A.git`\n2. Navigate to the samples directory: `cd A2A/samples/js/src/agents`\n3. Explore the Coder Agent implementation\n4. Follow the documentation to run or modify the agent\n\n## More Information\nFor more information about the A2A protocol and how to build your own agents, visit the [A2A GitHub repository](https://github.com/google/A2A).",
    content:
      'This is a simple code-writing agent that emits full code files as artifacts. Part of the Google Genkit sample agents.',
    url: 'https://github.com/google/A2A/tree/main/samples/js/src/agents',
    imageUrl: 'https://dummyimage.com/800x450/1d3557/ffffff&text=Coder+Agent',
  ...
  },
  {
    ...
    title: 'LangGraph - Currency Converter',
    detail:
      '# LangGraph - Currency Converter Agent\n\n## Overview\nThe Currency Converter Agent is built using LangGraph and demonstrates how to create a multi-turn conversational agent under the A2A (Agent2Agent) protocol. This agent can handle currency conversion tasks and supports both synchronous and streaming interactions.\n\n## Features\n- **Multi-turn Conversations**: Supports conversational exchanges to refine and complete currency conversion tasks\n- **Real-time Exchange Rates**: Provides current currency exchange information between various currencies\n- **Input Request**: Ability to request additional information when input is incomplete\n- **Streaming Support**: Provides incremental updates during processing for a more responsive experience\n- **A2A Protocol Implementation**: Demonstrates the use of A2A protocol for agent communication\n\n## Use Cases\n- **Financial Applications**: Integration with financial planning or expense tracking tools\n- **Travel Apps**: Helping travelers understand currency values in different countries\n- **E-commerce**: Providing price comparisons in local currencies\n- **Educational Tools**: Demonstrating currency relationships and economic concepts\n\n## Implementation Details\nThis agent uses LangGraph to build a graph-based conversation flow that can manage the state of currency conversion tasks. It supports different states like "working," "completed," and "input-required," allowing for rich interactions and progressive task completion.\n\n## How to Use\nDevelopers can explore this sample implementation to understand how to build multi-turn conversational agents using the A2A protocol. To use or modify this agent:\n\n1. Navigate to the samples directory: `cd samples/python`\n2. Create and configure the .env file with your API keys\n3. Run the agent: `uv run langgraph/agent`\n4. Interact with the agent using the provided client examples\n\n## Example Interactions\nThe agent supports multiple interaction patterns:\n\n- **Direct Queries**: "How much is 100 USD in EUR?"\n- **Multi-turn Conversations**: \n  - User: "How much is 1 USD?"\n  - Agent: "Which currency do you want to convert to?"\n  - User: "CAD"\n  - Agent: "The current exchange rate is 1 USD = 1.4328 CAD."\n- **Streaming Updates**: The agent can provide progress updates during processing\n\n## Prerequisites\n- Python 3.13 or higher\n- UV package manager\n- Access to an LLM and API Key\n\n## More Information\nFor more information about the A2A protocol and how to build your own agents, visit the [A2A GitHub repository](https://github.com/google/A2A).',
    content:
      'A currency conversion agent using LangGraph that supports multi-turn conversations to complete currency conversion tasks.',
    url: 'https://github.com/google/A2A/tree/main/samples/python/agents/langgraph',
    imageUrl: 'https://dummyimage.com/800x450/1d3557/ffffff&text=Currency+Converter',
  ...
  },
  {
    ...
    title: 'CrewAI - Image Generator',
    detail:
      "# CrewAI - Image Generator Agent\n\n## Overview\nThe Image Generator Agent is built using CrewAI and demonstrates how to create an agent that generates images based on text descriptions. This agent is hosted as an A2A server, showcasing the integration of AI image generation capabilities within the A2A protocol framework.\n\n## Features\n- **Text-to-Image Generation**: Creates images based on textual descriptions\n- **CrewAI Framework**: Leverages the CrewAI framework for agent orchestration\n- **A2A Protocol Integration**: Follows the A2A protocol for standardized agent communication\n- **Simple Interface**: Easy-to-use interface for requesting image generation\n\n## Use Cases\n- **Content Creation**: Generate visual content for articles, presentations, or marketing materials\n- **Creative Assistance**: Help designers with concept visualization\n- **Educational Tools**: Create explanatory visuals for complex concepts\n- **Prototyping**: Quickly generate visual mockups based on descriptions\n\n## Implementation Details\nThis agent uses CrewAI to structure the image generation workflow. CrewAI is a framework for orchestrating role-playing autonomous AI agents, and in this implementation, it's used to create an agent specialized in image generation tasks.\n\n## How to Use\nDevelopers can explore this sample implementation to understand how to build image generation agents using the A2A protocol and CrewAI. To use or modify this agent:\n\n1. Navigate to the samples directory: `cd samples/agents/crewai`\n2. Create a .env file and add your API keys\n3. Run the agent with the provided commands:\n   ```\n   uv python pin 3.12\n   uv venv\n   source .venv/bin/activate\n   uv run .\n   ```\n4. Use the client to interact with the agent: `uv run hosts/cli`\n\n## Prerequisites\n- Python 3.12 or higher\n- UV package manager\n- Access to an LLM and API Key (default is Google Gemini)\n\n## More Information\nFor more information about the A2A protocol and how to build your own agents, visit the [A2A GitHub repository](https://github.com/google/A2A).",
    content: 'A simple image generation agent built with CrewAI that demonstrates how to host an A2A server.',
    url: 'https://github.com/google/A2A/tree/main/samples/python/agents/crewai',
    imageUrl: 'https://dummyimage.com/800x450/1d3557/ffffff&text=Image+Generator',
    thumbnailUrl: 'https://dummyimage.com/400x225/1d3557/ffffff&text=Image+Generator',
  ...
  },
  {
    ...
    title: 'Google ADK - Expense Reimbursement',
    detail:
      "# Google ADK - Expense Reimbursement Agent\n\n## Overview\nThe Expense Reimbursement Agent is built using Google's Agent Development Kit (ADK) and demonstrates how to create an interactive agent that handles expense reimbursement requests. This agent is capable of collecting missing information through webforms and completing reimbursement tasks.\n\n## Features\n- **Interactive Webforms**: Generates and processes webforms to collect missing information\n- **Agent Development Kit**: Built using Google's ADK for standardized agent development\n- **Multi-step Processing**: Handles the complete expense reimbursement workflow\n- **A2A Protocol Integration**: Follows the A2A protocol for standardized agent communication\n- **User-friendly Interface**: Simplifies the expense submission process\n\n## Use Cases\n- **Business Operations**: Streamline expense reimbursement processes\n- **Financial Management**: Simplify expense tracking and processing\n- **Administrative Automation**: Reduce manual work in handling expense claims\n- **Employee Self-service**: Enable employees to submit and track reimbursement requests\n\n## Implementation Details\nThis agent uses the Agent Development Kit (ADK) to handle the expense reimbursement workflow. When a user submits a request with missing details, the agent generates a webform for the user to fill out. After the form is completed, the agent processes the information and completes the task.\n\n## How to Use\nDevelopers can explore this sample implementation to understand how to build interactive form-based agents using the A2A protocol and Google's ADK. To use or modify this agent:\n\n1. Navigate to the samples directory: `cd samples/python`\n2. Create a .env file under agents/google_adk and add your API keys\n3. Run the agent: `uv run google_adk/agent`\n4. Use one of the client apps to interact with the agent\n\n## Prerequisites\n- Python 3.9 or higher\n- UV package manager\n- Access to an LLM and API Key (default is Google Gemini)\n\n## More Information\nFor more information about the A2A protocol and how to build your own agents, visit the [A2A GitHub repository](https://github.com/google/A2A).",
    content:
      'An expense reimbursement agent built with the Agent Development Kit (ADK) that uses webforms to collect missing information.',
    url: 'https://github.com/google/A2A/tree/main/samples/python/agents/google_adk',
    imageUrl: 'https://dummyimage.com/800x450/1d3557/ffffff&text=Expense+Reimbursement',
