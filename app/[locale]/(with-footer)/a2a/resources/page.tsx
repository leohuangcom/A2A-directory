...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }): Promise<Metadata> {
  const t = await getTranslations({
    locale,
    namespace: 'Metadata.a2a.resources',
  });
    ...
    console.log(\`Received \${update.artifacts.length} candidates\`);
          ...
          <div className='space-y-6'>
            <div>
              ...
              <p className='text-gray-300'>
                ...
                <Link href='/a2a/overview' className='text-blue-400 hover:underline'>
                  Protocol Overview
                </Link>{' '}
                and
                <Link href='/a2a/specification' className='ml-1 text-blue-400 hover:underline'>
        ...
        <div className='mb-12 rounded-lg bg-gray-800 p-6'>
          ...
          <p className='text-white'>
            ...
            <Link href='/a2a/partners' className='ml-1 text-blue-400 hover:underline'>
